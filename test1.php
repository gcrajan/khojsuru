...
switch ($action) {
    ...
    case 'generate_ai_cv':
        ...
        $apiKey = "AIzaSyB_jjxf6xOdezlbc-hxMiIFhbF9NY-hohA";
    ...
    case 'send_otp':
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'bde73263effc82';
            $mail->Password   = 'c70f5536c65f46';
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port       = 587;

            $mail->setFrom('no-reply@recruitercv.com', 'RecruiterCV');
            $mail->addAddress($email);
            $mail->isHTML(true);
            $mail->Subject = 'Your Khojsuru Verification Code';
            $mail->Body    = "<h1>Your Verification Code</h1><p>Your one-time password is: <b>{$otp}</b></p><p>This code will expire in 10 minutes.</p>";
            $mail->send();
        } catch (Exception $e) {
